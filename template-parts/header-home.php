 ...
 * Header (Home)
 * - 初期状態: 透明背景 / 白文字
 * - スクロール時: 白背景 / 黒文字 (JSでクラス制御)
 * - SP時: ハンバーガーメニュー (黒背景オーバーレイ)
 */
?>
<!doctype html>
...
<header id="site-header" class="fixed left-0 top-0 z-50 w-full transition-all duration-300 ease-in-out text-white bg-transparent">
  <div class="mx-auto w-full max-w-[1440px] px-6 lg:px-10">
    <div class="flex h-20 items-center justify-between">

      <div class="flex-shrink-0 w-36"></div>

      <nav class="hidden lg:flex items-center gap-x-12 font-outfit text-sm font-bold tracking-[0.2em]">
        <a href="#works"   class="!no-underline transition-colors hover:opacity-70 group-[.is-scrolled]:text-black">WORKS</a>
        <a href="#service" class="!no-underline transition-colors hover:opacity-70 group-[.is-scrolled]:text-black">SERVICE</a>
        <a href="#blog"    class="!no-underline transition-colors hover:opacity-70 group-[.is-scrolled]:text-black">BLOG</a>
        <a href="#company" class="!no-underline transition-colors hover:opacity-70 group-[.is-scrolled]:text-black">COMPANY</a>
        <a href="#contact" class="!no-underline transition-colors hover:opacity-70 group-[.is-scrolled]:text-black">CONTACT</a>
      </nav>

      <div class="flex items-center gap-6">
        
        <div class="hidden lg:flex items-center gap-4 group-[.is-scrolled]:invert">
        ...
        <button id="menu-toggle" class="lg:hidden relative z-[60] w-8 h-6 flex flex-col justify-between focus:outline-none">
          <span class="block w-full h-[2px] bg-white transition-all duration-300 group-[.is-scrolled]:bg-black menu-bar-1"></span>
          <span class="block w-full h-[2px] bg-white transition-all duration-300 group-[.is-scrolled]:bg-black menu-bar-2"></span>
          <span class="block w-full h-[2px] bg-white transition-all duration-300 group-[.is-scrolled]:bg-black menu-bar-3"></span>
        </button>
...
<div id="mobile-menu-overlay" class="fixed inset-0 z-[55] bg-black text-white transform translate-x-full transition-transform duration-300 ease-in-out lg:hidden flex flex-col">
  
  <div class="flex-1 overflow-y-auto px-8 py-24 relative">
    ...
    <div class="mt-12">
      <div class="flex justify-end gap-6 mb-8">
         <a href="https://x.com/amt_web" class="block"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/icon-x-white.png" alt="X" class="w-8 h-8"></a>
         <a href="https://www.instagram.com/amt_web/" class="block"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/icon-instagram-white.png" alt="IG" class="w-8 h-8"></a>
      </div>
