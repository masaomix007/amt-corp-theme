      ...
      <div class="flex-shrink-0 w-auto min-w-[120px]">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="block hover:opacity-80 transition-opacity">
          <img 
            ...
            alt="AMT" 
            class="h-10 w-auto invert grayscale contrast-200" 
          > 
        </a>
      </div>
      ...
      <div class="flex items-center gap-6">
        <div class="hidden lg:flex items-center gap-4">
           <a href="https://x.com/amt_web" target="_blank" class="hover:opacity-70 transition-opacity">
             <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/icon-x-white.png" alt="X" class="w-6 h-6 object-contain invert-[0.8]">
           </a>
           <a href="https://www.instagram.com/amt_web/" target="_blank" class="hover:opacity-70 transition-opacity">
             <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/icon-instagram-white.png" alt="IG" class="w-6 h-6 object-contain invert-[0.8]">
           </a>
        </div>
        ...
        <nav class="space-y-6 font-noto">
            <div class="border-b border-gray-700 pb-4">
                ...
                <ul class="space-y-4 pl-4 text-sm font-light">
                    <li><a href="<?php echo esc_url(home_url('/works/website/')); ?>" class="!no-underline flex items-center gap-2 hover:text-gray-300"><span class="text-xs">&gt;</span> ホームページ制作・運用支援</a></li>
                    <li><a href="<?php echo esc_url(home_url('/works/graphic/')); ?>" class="!no-underline flex items-center gap-2 hover:text-gray-300"><span class="text-xs">&gt;</span> 印刷・グラフィック制作</a></li>
            ...
            */ ?>
            ...
            <div class="border-b border-gray-700 pb-4">
                <a href="<?php echo esc_url(home_url('/company/')); ?>" class="!no-underline block w-full text-sm hover:text-gray-300 flex items-center gap-2"><span class="text-xs">&gt;</span> 会社案内</a>
            </div>
            <div class="border-b border-gray-700 pb-4">
                <a href="<?php echo esc_url(home_url('/recruit/')); ?>" class="!no-underline block w-full text-sm hover:text-gray-300 flex items-center gap-2"><span class="text-xs">&gt;</span> 採用情報</a>
            </div>
        </nav>
        <div class="mt-12">
